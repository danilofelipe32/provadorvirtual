...
const REMIX_SUGGESTIONS = [
  ...
  "Ideia de remix: Integrar uma API de e-commerce para encontrar itens similares.",
  "Ideia de remix: Adicionar acessórios como chapéus, óculos de sol ou bolsas.",
  "Ideia de remix: Criar uma 'pontuação de estilo' para os looks.",
  "Ideia de remix: Permitir que os usuários salvem seus looks favoritos.",
