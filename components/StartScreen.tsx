  ...
  const handleFileSelect = useCallback(async (file: File) => {
    ...
    reader.onload = async (e) => {
        ...
        try {
            ...
            setError(getFriendlyErrorMessage(err, 'Falha ao criar a modelo'));
          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              <h1 className="text-5xl md:text-6xl font-serif font-bold text-gray-900 leading-tight">
                Crie Sua Modelo para Qualquer Look.
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Já se perguntou como uma roupa ficaria em você? Pare de adivinhar. Envie uma foto e veja por si mesmo. Nossa IA cria sua modelo pessoal, pronta para experimentar qualquer coisa.
              </p>
