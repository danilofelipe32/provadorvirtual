...
const WardrobePanel: React.FC<WardrobePanelProps> = ({ onGarmentSelect, activeGarmentIds, isLoading, wardrobe }) => {
    ...
    const handleGarmentClick = async (item: WardrobeItem) => {
        ...
        try {
            ...
            const detailedError = `Falha ao carregar o item do guarda-roupa. Isso geralmente é um problema de CORS. Verifique o console do desenvolvedor para mais detalhes.`;
